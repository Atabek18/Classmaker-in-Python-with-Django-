...
CKEDITOR_CONFIGS = {
    "default": {
        ...
        "toolbar_YourCustomToolbarConfig": [
            ...
            {
                "name": "tools",
                "items": ["Maximize", "CodeSnippet", "Youtube", "Html5video"],
            },
        ],
...
MIDDLEWARE = [
    ...
    "API_TEST.middlewares.CustomCsrfMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "API_TEST.middlewares.SessionUserMiddleware",
]
...
# DATABASES = {
#     "default": {
#         "ENGINE": "django.db.ba   ckends.sqlite3",
...
STATIC_URL = "static/"
STATICFILES_DIRS = [os.path.join("reactapp/build", "static"), os.path.join("static")]
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = "umidyor007@gmail.com"
EMAIL_HOST_PASSWORD = "hlcrgqqdqfhjalxb"
...
AUTH_USER_MODEL = "TestingSystem.CustomUser"
BOOTSTRAP_DATEPICKER_PLUS = {
